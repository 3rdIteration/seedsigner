...
Additional options allow you to verify existing signatures or sign files with a loaded private key. Detached signatures are written alongside the original file so they can be verified later.
