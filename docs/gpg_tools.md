...
For environments without `gpg2`, a standalone console script is available at `tools/bip85_pgp.py`. It prompts for a mnemonic, derives a BIP85-based key, optionally adds extra subkey sets, and prints the public or private key in ASCII-armored form.
