...
class SeedSignerIconConstants:
    """
        Re-export SeedSigner-specific icons from FontAwesomeIconConstants for backward
        compatibility with existing code that references SeedSignerIconConstants.*
    """
    # Menu icons
    SCAN = FontAwesomeIconConstants.SCAN
    SEEDS = FontAwesomeIconConstants.SEEDS
    SETTINGS = FontAwesomeIconConstants.SETTINGS
    TOOLS = FontAwesomeIconConstants.TOOLS

    # Utility icons
    BACK = FontAwesomeIconConstants.BACK
    CHECK = FontAwesomeIconConstants.CHECK
    CHECKBOX = FontAwesomeIconConstants.CHECKBOX
    CHECKBOX_SELECTED = FontAwesomeIconConstants.CHECKBOX_SELECTED
    CHEVRON_DOWN = FontAwesomeIconConstants.CHEVRON_DOWN
    CHEVRON_LEFT = FontAwesomeIconConstants.CHEVRON_LEFT
    CHEVRON_RIGHT = FontAwesomeIconConstants.CHEVRON_RIGHT
    CHEVRON_UP = FontAwesomeIconConstants.CHEVRON_UP
    PLUS = FontAwesomeIconConstants.PLUS
    POWER = FontAwesomeIconConstants.POWER
    RESTART = FontAwesomeIconConstants.RESTART

    # Messaging icons
    INFO = FontAwesomeIconConstants.INFO
    SUCCESS = FontAwesomeIconConstants.SUCCESS
    WARNING = FontAwesomeIconConstants.WARNING
    ERROR = FontAwesomeIconConstants.ERROR

    # Informational icons
    CHANGE = FontAwesomeIconConstants.CHANGE
    DERIVATION = FontAwesomeIconConstants.DERIVATION
    FINGERPRINT = FontAwesomeIconConstants.FINGERPRINT
    PASSPHRASE = FontAwesomeIconConstants.PASSPHRASE

    # Misc icons
    BITCOIN_ALT = FontAwesomeIconConstants.BITCOIN_ALT
    MICROSD = FontAwesomeIconConstants.MICROSD
    QRCODE = FontAwesomeIconConstants.QRCODE
    SIGN = FontAwesomeIconConstants.SIGN

    # Input icons
    DELETE = FontAwesomeIconConstants.DELETE
    SPACE = FontAwesomeIconConstants.SPACE
