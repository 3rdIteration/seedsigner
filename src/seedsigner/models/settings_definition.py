...
class SettingsDefinition:
    ...
    settings_entries: List[SettingsEntry] = [
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__SYSTEM,
                    ...
                    display_name=_mft("Smartcard Interfaces"),
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__SYSTEM,
                    ...
                    display_name=_mft("Auto PIN on insert"),
                    help_text=_mft("Show a toast notification when a recognised card is inserted, prompting you to enter the PIN once. Off by default for low-profile use."),
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__FEATURES,
                      ...
                      display_name=_mft("Encryption Mode"),
                      type=SettingsConstants.TYPE__SELECT_1,
                      visibility=SettingsConstants.VISIBILITY__ADVANCED,
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__FEATURES,
                      ...
                      display_name=_mft("Encryption Iter.(PBKDF2)"),
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__SYSTEM,
                      ...
                      display_name=_mft("Stealth boot"),
                      type=SettingsConstants.TYPE__ENABLED_DISABLED,
                      visibility=SettingsConstants.VISIBILITY__HIDDEN,
                      default_value=SettingsConstants.OPTION__DISABLED),
        SettingsEntry(category=SettingsConstants.CATEGORY__SYSTEM,
                      attr_name=SettingsConstants.SETTING__STEALTH_UNLOCK_SEQUENCE,
                      display_name=_mft("Stealth unlock sequence"),
                      type=SettingsConstants.TYPE__FREE_ENTRY,
                      visibility=SettingsConstants.VISIBILITY__HIDDEN,
