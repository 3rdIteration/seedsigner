...
class SettingsConstants:
    ...
    SETTING__ENCRYPTION_MODE = "encryption_mode"
    SETTING__ENCRYPTION_ITER = "encryption_iter"
    SETTING__AMBIGUOUS_QR = "ambiguous_qr"
    SETTING__WIF_KEYS = "wif_keys"
    SETTING__BIP38_KEYS = "bip38_keys"
    SETTING__GPG_KEY_TYPES = "gpg_key_types"
    SETTING__SATOCHIP_SIGN_TIMEOUT = "satochip_timeout"
    SETTING__SATOCHIP_MSG_SIGN_TIMEOUT = "satochip_msg_timeout"
    SETTING__SATOCHIP_MAX_PRE_DUMMIES = "satochip_pre_dummies"
    SETTING__SATOCHIP_MAX_POST_DUMMIES = "satochip_post_dummies"
    SETTING__SATOCHIP_MAX_IN_TX_DUMMIES = "satochip_in_tx_dummies"
    SETTING__SATOCHIP_DUMMY_PROBABILITY = "satochip_dummy_prob"
