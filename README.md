...
* GPG Tools
   - GPG Signature verification & Sha256 Manifest check (Includes pubkey bundle the from Sparrow to verify Seedsigner, Sparrow, Electrum, plus many more)
    ...
    - Advanced submenu can add three subkeys of a user-selected type, list subkeys, and copy them to a smartcard; BIP85-derived keys use deterministic BIP85 subkeys with successive indexes
